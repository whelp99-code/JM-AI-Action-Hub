...
REQUIRED_OPERATIONS = {
    ...
    ("POST", "/api/v1/mobile/followups/{followup_id}/resolve"): "resolveMobileFollowup",
...
REQUIRED_SCHEMA_FIELDS = {
    ...
    "FocusActionSummary": {"action_item_id", "estimated_minutes", "executor", "assessment", "energy_level"},
    ...
    "DualBig3Response": {
        ...
        "ai",
        "overload_minutes",
        "human_remaining_minutes",
        "ai_remaining_minutes",
    ...
    "FocusDashboardSummary": {
        ...
        "human_big3",
        "ai_big3",
        "human_big3_recommendations",
        "ai_big3_recommendations",
    },
